		...
		while getgenv().ka == true do
			...
			for _,player in next,game:GetService'Players':GetPlayers() do
				if player ~= LocalPlayer then
					local args = { [1] = player }
					local Distance = (player.Character:FindFirstChildOfClass("Part").Position - LocalPlayer.Character:FindFirstChildOfClass("Part").Position).magnitude
...
InfoTab:AddLabel("Last updated: 4/13/2024")
